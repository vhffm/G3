"""
Plot Semi-Major Axis vs. Inclination. 3 Panels. Stack.
...
for nstep in nsteps:
    ...
    for isim in [ 0, 1, 2 ]:
        ...
        # Inner Cutoff
        ax.fill_between([0.0, 0.1], 0.0, 60.0, \
                        lw=0, facecolor='r', \
                        alpha=0.1, zorder=20)
    ...
    axarr[0].set_ylabel('Inclination (Degree)', fontsize='small')
    ...
    # Save Figure
    fig.savefig("ai3_stacked_%012d.png" % nstep, bbox_inches='tight')
